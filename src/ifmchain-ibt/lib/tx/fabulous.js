    ...
    _createClass(Fabulous, [
        ...
        },
        {
            ...
            value: function validateInput(data, cb) {
                Validator.validate(data, undefined, cb);
            },
        ...
        },
        {
            ...
            value: function verify(trs, sender, cb) {
                ...
                baddress = testStart.test(baddress)
                    ? baddress.substr(1)
                    : baddress;
        ...
        },
        {
            ...
            value: function getBytes(trs) {
                var bb = null;
                var fabulousAddress = new Buffer(
                    trs.asset.fabulous.address,
                    "utf8"
                );
        ...
        },
        {
            ...
            value: function objectNormalize(trs) {
                ...
                if (!report) {
                    throw Error(
                        "Incorrect address in fabulous transaction: " +
        ...
        },
        {
            ...
            value: function dbSave(trs, cb) {
                library.dbLite.query(
                    "INSERT INTO fabulous(address, transactionId) VALUES($address, $transactionId)",
                    {
