    ...
    },
    {
      ...
      value: function getBytes(trs) {
        ...
        if (trs.asset.dapp.certificate) {
          buf = Buffer.concat([
            buf,
            new Buffer(trs.asset.dapp.certificate.toString(), "utf8"),
          ]);
        }
        ...
        if (trs.asset.dapp.coverPicture) {
          buf = Buffer.concat([
            buf,
            new Buffer(trs.asset.dapp.coverPicture.toString(), "utf8"),
          ]);
        }
        ...
        if (trs.asset.dapp.downloadAddress) {
          buf = Buffer.concat([
            buf,
            new Buffer(trs.asset.dapp.downloadAddress.toString(), "utf8"),
          ]);
        }
