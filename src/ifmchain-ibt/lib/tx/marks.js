    ...
    _createClass(Mark, [
        ...
        },
        {
            ...
            value: function verify(trs, sender, cb) {
                ...
                try {
                    ...
                    //判断公钥是否合法
                    if (
                        trs.asset.mark.creatorPublicKey.length != 64 ||
                        !new Buffer(trs.asset.mark.creatorPublicKey, "hex")
                            .length
                    ) {
                        return cb({
        ...
        },
        {
            ...
            value: function getBytes(trs) {
                ...
                if (trs.asset.mark.content) {
                    buf = Buffer.concat([
                        buf,
                        new Buffer(trs.asset.mark.content, "utf8"),
                    ]);
                }
                ...
                if (trs.asset.mark.creatorPublicKey) {
                    buf = Buffer.concat([
                        buf,
                        new Buffer(trs.asset.mark.creatorPublicKey, "utf8"),
                    ]);
                }
                ...
                if (trs.asset.mark.action) {
                    buf = Buffer.concat([
                        buf,
                        new Buffer(trs.asset.mark.action, "utf8"),
                    ]);
                }
        ...
        },
        {
            ...
            value: function objectNormalize(trs) {
                ...
                if (!report) {
                    throw Error(
                        "Can't parse mark: " + library.scheme.getLastError(),
                    );
                }
