  ...
  _createClass(InTransfer, [
    ...
    },
    {
      ...
      value: function apply(trs, block, sender, cb) {
        shared.getGenesis({ dappid: trs.asset.inTransfer.dappId }, function(
          err,
          res
        ) {
          if (err) {
    ...
    },
    {
      ...
      value: function objectNormalize(trs) {
        ...
        if (!report) {
          throw Error(
            "Can't verify dapp in transaction, incorrect parameters: " +
    ...
    },
    {
      ...
      value: function dbSave(trs, cb) {
        library.dbLite.query(
          "INSERT INTO intransfer(dappId, transactionId) VALUES($dappId, $transactionId)",
          {
