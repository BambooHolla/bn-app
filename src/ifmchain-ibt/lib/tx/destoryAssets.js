    ...
    _createClass(DestoryAssets, [
        {
            ...
            value: function create(data, trs) {
                ...
                trs.asset.destoryAsset = {
                    ...
                    abbreviation:
                        data.asset.destoryAsset.abbreviation ||
                        "" /* ,
        ...
        },
        {
            ...
            value: function verify(trs, sender, cb) {
                ...
                if (trs.asset.destoryAsset.assetName) {
                    if (
                        trs.asset.destoryAsset.assetName.length < 3 ||
                        trs.asset.destoryAsset.assetName.length > 30
                    ) {
                        return cb({
                            message:
                ...
                if (trs.asset.destoryAsset.abbreviation) {
                    if (
                        trs.asset.destoryAsset.abbreviation.length < 3 ||
                        trs.asset.destoryAsset.abbreviation.length > 5
                    ) {
                        return cb({
                            message:
        ...
        },
        {
            ...
            value: function getBytes(trs) {
                ...
                if (trs.asset.destoryAsset.abbreviation) {
                    var abbrBuf = Buffer.from(
                        trs.asset.destoryAsset.abbreviation,
                    );
        ...
        },
        {
            ...
            value: function objectNormalize(trs) {
                for (var i in trs.asset.destoryAsset) {
                    if (
                        trs.asset.destoryAsset[i] === null ||
                        typeof trs.asset.destoryAsset[i] === "undefined"
                    ) {
