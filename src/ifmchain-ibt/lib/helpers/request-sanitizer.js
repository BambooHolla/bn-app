...
var RequestSanitizer = (function(_Validator) {
  ...
  function RequestSanitizer(options) {
    ...
    return _possibleConstructorReturn(
      this,
      (
        RequestSanitizer.__proto__ || Object.getPrototypeOf(RequestSanitizer)
      ).call(this, options)
    );
  }
...
RequestSanitizer.addRule("array", {
  filter: function filter(accept, value, field) {
    ...
    if (
      typeof value === "string" &&
      (typeof accept === "string" || accept instanceof RegExp)
    ) {
...
RequestSanitizer.addRule("maxByteLength", {
  ...
  accept: function accept(_accept) {
    if (
      (typeof _accept === "undefined" ? "undefined" : _typeof(_accept)) !==
      "object"
    ) {
      _accept = {
        encoding: "utf8",
...
RequestSanitizer.addRule("minByteLength", {
  ...
  accept: function accept(_accept2) {
    if (
      (typeof _accept2 === "undefined" ? "undefined" : _typeof(_accept2)) !==
      "object"
    ) {
      _accept2 = {
        encoding: "utf8",
...
RequestSanitizer.express = function(options) {
  ...
  return function(req, res, next) {
    ...
    function sanitize(value, properties, callback) {
      ...
      return new RequestSanitizer(options).validate(
        values,
...
[
  ...
  RequestSanitizer[name] = function filter(value, extra) {
    var rules = {};
    if (
      (typeof extra === "undefined" ? "undefined" : _typeof(extra)) === "object"
    ) {
      extend(rules, extra);
    ...
    var report = new RequestSanitizer(RequestSanitizer.options).validate(
      value,
      rules
    );
    if (!report.isValid) {
