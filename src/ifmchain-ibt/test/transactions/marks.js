...
var secret =
  "remain lounge resist notable company dance phone happy tunnel fiscal stomach orchard";
var secret2 =
  "guard unique resemble unhappy cherry volcano ship random come nephew horn eternal";
//publickey come from secret
var publicKey =
  "c73e5ad89249e0c5347843d31f9cfef8f8a0d423deeec6910badfbd504691c08";
...
var ifmchainAccount = {
  password:
    "brass pyramid panel pottery satisfy coyote midnight truck dignity solve ocean dune",
...
describe("marks.js", function() {
  ...
  it("get dapp should be ok", function(done) {
    api.get("/dapps").then(function(data) {
      data.body.success.should.equal(true);
      data.body.dapps[0].should.have
