...
describe("vote.js", function() {
  ...
  describe("#createTransaction without second secret", function() {
    ...
    var sender = {
      ...
      publicKey:
        "38d0f0a0647a4a60d22f04663a3e6a0a3374fb78e96122d7cbfb696dd00bc46f",
    ...
    var data = {
      ...
      secret:
        "hollow strong save audit rookie gossip small rough scan fox soon size",
      //支付账户的金额
      //recipientUsername:
      //支付账户的公钥
      publicKey:
      ...
      asset: {
        votes: [
          "+3b3ccba6dc3817eab715479bf2932a4ac44522a3a5cc8c77bf77a84d31b0cc6f",
          "+188f2ec5fbcf2260da09892057f430c7a9db77e67f0b47e4b3f734014749eee7",
        ],
      },
    };
    ...
    describe("returned contact transaction " + name, function() {
      ...
      if (!data.secondSecret) {
        ...
        it("should be second signed correctly", function() {
          var result = ifmchain.tx.verifySecondSignature(
            trs,
  ...
  describe("#createTransaction with second secret", function() {
    ...
    var sender = {
      ...
      publicKey:
        "45cdaf3b75ad8f700e09d8c308a7459beebbb7dc87af60d57b4e6eb01085880e",
      unconfirmedSignature: false,
      secondSignature: true,
      secondPublicKey:
        "b8a4ba8029ead9a15385e704b44d39c9b2cdde5254593538f2211fc924b20f6d",
      multisignatures: [],
      u_multisignatures: [],
    };
    var data = {
      type: transactionTypes.VOTE,
      secret:
        "congress suffer example shuffle regret throw wasp apple orchard zero foil velvet",
