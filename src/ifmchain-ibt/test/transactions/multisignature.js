...
describe("multisignature.js", function() {
  ...
  describe("#createTransaction without second secret", function() {
    ...
    var sender = {
      ...
      balance: 0,
      publicKey:
        "8fb8c99a5de9f8282accac33d1efa6591b60d5cfd75f177f45f360f977a04bd4",
    ...
    var data = {
      ...
      secret:
        "scan pull clean own kiss relax clog defense lawn sort badge portion",
      //支付账户的金额
      //recipientUsername:
      //支付账户的公钥
      publicKey:
      ...
      asset: {
        multisignature: {
          min: 2,
          keysgroup: [
            "+ecb36148638dcf1ffba122d8ba0e7b8f858251a6eb551301a23866e2b3487739",
            "+90aa21c74914f4b1ad55a9b0722b5034410152ee8c88729be0ec24d60aa69fdd",
            "+5e9b08d271baa4d6e2472dbc26c5d87e24a0464c57b83e15b328486606ca728a",
          ],
          lifetime: 1,
        },
      },
  ...
  describe("#createTransaction with second secret", function() {
    ...
    var sender = {
      ...
      secondSignature: false,
      secondPublicKey:
        "6546c6165825dcea53dad6da2abb46f4df2f39a2a73dc1dac088169d2eba8e27",
      multisignatures: [],
      u_multisignatures: [],
    };
    var data = {
      ...
      //支付账户的支付密码
      secondSecret:
        "dinosaur brand this kiwi humor multiply glue dune cradle add avoid trash",
      //多重签名账户的公钥
      //multisigAccountPublicKey: "",
      fee: 1,
      asset: {
